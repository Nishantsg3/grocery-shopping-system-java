...
Below are real execution screenshots captured from the terminal and files generated by the application:

### Order Flow & Billing
![Order Flow](preview/order.png)

### Inventory Persistence
![Inventory File](preview/inventory.png)

### Generated Receipt
![Receipt Output](preview/receipt.png)
